...
int main(int argc, char *argv[]) {
    ...
    @autoreleasepool {
        ...
        main_script = [[[NSBundle mainBundle] pathForResource:@"Library/Application Support/com.ifujun.apptest.apptest/app/apptest/__main__"
                                                       ofType:@"py"]
                                         cStringUsingEncoding:NSUTF8StringEncoding];

        if (main_script == NULL) {
            NSLog(@"Unable to locate apptest main module file");
            exit(-1);
        }
